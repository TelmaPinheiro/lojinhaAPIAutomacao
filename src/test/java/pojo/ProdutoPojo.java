...
public class ProdutoPojo {
    ...
    private List<ComponentePojo> compoentes;
    ...
    public List<ComponentePojo> getCompoentes() {
        return compoentes;
    }

    public void setCompoentes(List<ComponentePojo> compoentes) {
        this.compoentes = compoentes;
    }
}
